...
func make_shared_x_continuous_plot(p_plot: TauPlot, p_title: String, p_interpolation: TauLineConfig.InterpolationMode, p_tile_rotation_deg: float) -> void:
	...
	fill_b.tile_rotation_deg = p_tile_rotation_deg
...
func make_per_series_x_continuous_plot(p_plot: TauPlot, p_title: String, p_interpolation: TauLineConfig.InterpolationMode, p_tile_rotation_deg: float) -> void:
	var series_names := PackedStringArray(["Series A", "Series B"])
...
func make_shared_x_categorical_plot(p_plot: TauPlot, p_title: String, p_interpolation: TauLineConfig.InterpolationMode, p_tile_rotation_deg: float) -> void:
	var series_names := PackedStringArray(["Series A", "Series B"])
...
func _setup_test_1() -> void:
	make_shared_x_continuous_plot(%TestPlot1, "SHARED_X + CONTINUOUS, rotation = 0°", TauLineConfig.InterpolationMode.LINEAR, 0.0)
...
func _setup_test_2() -> void:
	make_per_series_x_continuous_plot(%TestPlot2, "PER_SERIES_X + CONTINUOUS, rotation = 0°", TauLineConfig.InterpolationMode.LINEAR, 0.0)
...
func _setup_test_3() -> void:
	make_shared_x_categorical_plot(%TestPlot3, "SHARED_X + CATEGORICAL, rotation = 0°", TauLineConfig.InterpolationMode.LINEAR, 0.0)
...
func _setup_test_4() -> void:
	make_shared_x_continuous_plot(%TestPlot4, "SHARED_X + CONTINUOUS, rotation = 45°", TauLineConfig.InterpolationMode.LINEAR, 45.0)
...
func _setup_test_5() -> void:
	make_per_series_x_continuous_plot(%TestPlot5, "PER_SERIES_X + CONTINUOUS, rotation = 45°", TauLineConfig.InterpolationMode.LINEAR, 45.0)
...
func _setup_test_6() -> void:
	make_shared_x_categorical_plot(%TestPlot6, "SHARED_X + CATEGORICAL, rotation = 45°", TauLineConfig.InterpolationMode.LINEAR, 45.0)
...
func _setup_test_7() -> void:
	make_shared_x_continuous_plot(%TestPlot7, "SHARED_X + CONTINUOUS, rotation = 90°", TauLineConfig.InterpolationMode.LINEAR, 90.0)
...
func _setup_test_8() -> void:
	make_per_series_x_continuous_plot(%TestPlot8, "PER_SERIES_X + CONTINUOUS, rotation = 90°", TauLineConfig.InterpolationMode.LINEAR, 90.0)
...
func _setup_test_9() -> void:
	make_shared_x_categorical_plot(%TestPlot9, "SHARED_X + CATEGORICAL, rotation = 90°", TauLineConfig.InterpolationMode.LINEAR, 90.0)
