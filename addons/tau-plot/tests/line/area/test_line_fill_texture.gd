...
const DOTS_TEXTURE := preload("res://addons/tau-plot/tests/assets/light_dots.png")
...
func make_shared_x_continuous_plot(p_plot: TauPlot, p_title: String, p_interpolation: TauLineConfig.InterpolationMode) -> void:
	...
	line_config.style.fill_texture = DOTS_TEXTURE
	line_config.style.fill_texture_tiling = Vector2(1.0, 1.0)
