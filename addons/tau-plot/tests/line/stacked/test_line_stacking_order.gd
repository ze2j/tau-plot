...
func _setup_test_1() -> void:
	...
	var bindings: Array[TauXYSeriesBinding] = [sb_c, sb_a, sb_b]
...
func _setup_test_2() -> void:
	...
	var line_config := TauLineConfig.new()
	line_config.mode = TauLineConfig.LineMode.STACKED
	line_config.stacked_normalization = TauLineConfig.StackedNormalization.FRACTION
	...
	var bindings: Array[TauXYSeriesBinding] = [sb_b, sb_a, sb_c]
...
func _setup_test_3() -> void:
	...
	var line_config := TauLineConfig.new()
	line_config.mode = TauLineConfig.LineMode.STACKED
	line_config.stacked_normalization = TauLineConfig.StackedNormalization.PERCENT
	...
	var bindings: Array[TauXYSeriesBinding] = [sb_a, sb_c, sb_b]
...
func _setup_test_6() -> void:
	...
	var bindings: Array[TauXYSeriesBinding] = [sb_b, sb_c, sb_a]
