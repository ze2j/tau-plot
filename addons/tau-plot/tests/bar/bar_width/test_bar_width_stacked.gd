...
func _step_test_4() -> void:
	...
	bar_config.bar_width_log_factor = clampf(1.5 + 0.5 * sin(_t * 0.8), 1.0, 2.0)
	plot.refresh_now()
...
func _step_test_7() -> void:
	...
	bar_config.neighbor_spacing_fraction = clampf(0.5 + 0.5 * sin(_t * 0.9), 0.0, 1.0)
	plot.refresh_now()
...
func _step_test_8() -> void:
	...
	bar_config.neighbor_spacing_fraction = clampf(0.5 + 0.5 * sin(_t * 0.9), 0.0001, 1.0)
	plot.refresh_now()
