...
func _setup_test_3() -> void:
	...
	%TestPlot3.title = "[Policy = THEME][LINEAR] Override bar_width_px [0, 50]"
	...
	%TestPlot3.theme = themes[THEME_10_0_INDEX]
...
func _setup_test_4() -> void:
	...
	%TestPlot4.title = "[Policy = THEME][LOGARITHMIC] Override bar_width_px [0, 50]"
	...
	%TestPlot4.theme = themes[THEME_10_0_INDEX]
