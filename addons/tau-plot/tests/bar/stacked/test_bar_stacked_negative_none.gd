...
func _setup_test_1() -> void:
	...
	var y_a := PackedFloat64Array([-5.0, -10.0, 15.0, -20.0, 20.0])
	var y_b := PackedFloat64Array([25.0, -30.0, -35.0, -40.0, 40.0])
	var y_c := PackedFloat64Array([30.0, 40.0, -50.0, -60.0, 60.0])
	...
	y_axis.tick_count_preferred = 15
	...
	bar_config.stacked_negative_policy = TauBarConfig.StackedNegativePolicy.SKIP_NEGATIVES
...
func _setup_test_2() -> void:
	...
	bar_config.mode = TauBarConfig.BarMode.STACKED
	bar_config.stacked_normalization = TauBarConfig.StackedNormalization.NONE
	bar_config.stacked_negative_policy = TauBarConfig.StackedNegativePolicy.DIVERGING
