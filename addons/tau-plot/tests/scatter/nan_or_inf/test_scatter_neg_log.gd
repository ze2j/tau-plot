...
func _setup_test_1() -> void:
	...
	%TestPlot1.title = "[LOG X, LINEAR Y] with PER_SERIES_X dataset (4th x value is negative for series A)"
...
func _setup_test_2() -> void:
	...
	%TestPlot2.title = "[LINEAR X, LOG Y] with PER_SERIES_X dataset (4th y value is negative for series A)"
...
func _setup_test_3() -> void:
	...
	%TestPlot3.title = "[LOG X, LINEAR Y] with SHARED_X dataset (4th x value is negative)"
...
func _setup_test_4() -> void:
	...
	%TestPlot4.title = "[LINEAR X, LOG Y] with SHARED_X dataset (4th y value is negative for series A)"
